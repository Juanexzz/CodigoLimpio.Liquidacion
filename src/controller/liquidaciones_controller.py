    ...
    def modificar_por_id(id_liquidacion: int, nueva: EmpleadoLiquidacion):
        ...
        cursor.execute(f"""
            UPDATE liquidacion_empleado SET
                salario_auxilio = {nueva.salario_auxilio},
                salario_sin_auxilio = {nueva.salario_sin_auxilio},
                salario_variable = {nueva.salario_variable},
                fecha_inicio = '{nueva.fecha_inicio.date()}',
                fecha_fin = '{nueva.fecha_fin.date()}',
                dias_suspension = {nueva.dias_suspension},
                dias_indemnizacion = {nueva.dias_indemnizacion}
